...
public class WeatherReadingTest {
  ...
  @Before
  public void setUp() {
    reading = createReading(25.4, 19.5, 34.0, 9);
  }
   ...
   */
  protected WeatherReading createReading(double airT, double dewT, double v, int rain) {
  ...
  public void testInvalidDewPointTemp() {
    createReading(19.0, 20.0, 35.0, 10);
  }
  ...
  public void testInvalidWindSpeed() {
    createReading(20.0, 18.0, -100, 11);
  }
  ...
  public void testInvalidTotalRain() {
    createReading(21.0, 10.0, 2.35, -10);
  }
  ...
  public void testInvalidR() {
    createReading(55.5, -10.0, 30.0, 12);
  }
  ...
  public void testEquals() {
    ...
    assertFalse(reading.equals(createReading(19.0, 10.0, 35.0, 10)));
  }
  ...
  public void testHashCode() {
    assertEquals(reading.hashCode(), createReading(25.4, 19.5, 34.0, 9).hashCode());
  }
